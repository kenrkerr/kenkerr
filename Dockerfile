...
#RUN cd /usr/local/ccminer-cryptonight; echo /usr/local/ccminer/ccminer  --threads=4 -o stratum+tcp://monerohash.com:5555 --user=49uvSMKeK4ieyNb2Chng3G3TVBtTAib1d5bLDTimtbnBQXBAWsgTd5AMLn1mWrpejeLewm9Wv643QKiZVUQnmn4FRhTuSQq -p x >monerorun4
#RUN cd /usr/local/ccminer-cryptonight; echo \#\!/bin/bash>moneroplus;echo /usr/local/ccminer/ccminer  -o stratum+tcp://monerohash.com:5555 --user=49uvSMKeK4ieyNb2Chng3G3TVBtTAib1d5bLDTimtbnBQXBAWsgTd5AMLn1mWrpejeLewm9Wv643QKiZVUQnmn4FRhTuSQq -p x \$\*>-moneroplus
